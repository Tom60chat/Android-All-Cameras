...
namespace Camera2Basic
{
    public class Camera2BasicFragment : Fragment, View.IOnClickListener, FragmentCompat.IOnRequestPermissionsResultCallback
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            view.FindViewById(Resource.Id.lens).SetOnClickListener(this);
        }
        ...
        public override void OnResume()
        {
            ...
            if (mTextureView.IsAvailable)
            {
                if (string.IsNullOrEmpty(mCameraId))
                    ...
                    OpenCamera(mTextureView.Width, mTextureView.Height, mCameraId);
            }
            else
            {
        ...
        public void OpenCamera(int width, int height, string cameraId = "")
        {
        ...
        public void OnClick(View v)
        {
            ...
            else if (v.Id == Resource.Id.lens)
            {
                Activity activity = Activity;
                if (activity != null)
                {
                    var camerasId = ExtraCamera.GetAllCameraIdList(activity);

                    AlertDialog.Builder builder = new AlertDialog.Builder(activity);
                        builder.SetTitle("Choose an lens");
                    builder.SetItems(camerasId, (s, e) =>
                    {
                        CloseCamera();
                        OpenCamera(mTextureView.Width, mTextureView.Height, camerasId[e.Which]);
                    });
